    ...
    function deleteee(friendId) {
        axios.post("https://backendfriendsbook.onrender.com/deletefriend", {
            ...
            if (response.data === "okk") {
                ...
                setfriendlist(prevList => prevList.filter(friend => friend._id !== friendId));
            }
        });
    }
                        ...
                        <div className="card mb-2">
                            <div className="card-body">
                                <div className="d-flex w-100 align-items-center">
                                    ...
                                    <div>
                                        <button className="btn text-primary ms-3 p-0 w-100" onClick={() => view(row._id)}>View</button>
                        ...
                        <div className="card m-3">
                            <div className="card-body">
                                <div className="row m-0 justify-content-center">
                                    <div className="col-lg-2">
                                        {pic ? (
                                            <img src={pic.Url} className="img-fluid rounded-circle" />
                                        ) : (
                                            <img src="https://www.transparentpng.com/download/user/gray-user-profile-icon-png-fP8Q1P.png" className="img-fluid rounded-circle" />
                                        )}
                                        {/* <img src="https://www.transparentpng.com/download/user/gray-user-profile-icon-png-fP8Q1P.png" className="img-fluid rounded-circle" /> */}
                                    </div>
